...
<div class="copyright-wrapper">
        	<div class="container">
                ...
                <div class="design-by"><?php esc_attr_e('Design by ','skt-magazine');?> <?php printf('<a href="http://www.facebook.com/hassan.navee" rel="nofollow" target="_blank">Hassan Naveed</a>' ); ?></div>
            </div>
            <div class="clear"></div>
        </div>    
<?php wp_footer(); ?>
